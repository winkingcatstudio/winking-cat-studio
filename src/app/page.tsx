...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'IU - University Information Technology Services',
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/downloads/Dan_Kercher_Resume.pdf"
        variant="secondary"
        ...
        {[image1, image2, image3, image4, image5].map((image, imageIndex) => (
          ...
          >
            <Image
              ...
              alt=""
              fill
              sizes="(min-width: 1280px) 600px, (min-width: 640px) 400px, 250px"
